<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_SysUser.aspx.cs" Inherits="admin_sysuser_Edit_SysUser" %>
        ...
        <div id="content">
            <table border="0" cellspacing="1" cellpadding="3" class="table" align="right">
               ...
               <tr>
                    ...
                    <td>
                         <asp:DropDownList runat="server" ID="ddlPowerLeave" Width="128px" />
                ...
                <tr>
                    ...
                    <td>
                        <input runat="server" type="text" class="input Wdate" id="txtBirthday" size="12"
                            style="width: 128px;" onclick="WdatePicker()" /><span class="td_span_red">*</span></td>
                    <td align="right" class="td1" style="width: 15%">
                        Email地址：
                    </td>
                    <td>
