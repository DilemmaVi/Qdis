...
namespace 渠道客服系统.Nhome.Ajax
{
    ...
    /// SHYGdata 的摘要说明
    /// </summary>
    public class SHYGdata : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (date == "0")
            {
                ...
                cmd.CommandText = string.Format("select TOP(1) 日期 from SHYGdata order by CONVERT(date,日期) desc");
            ...
            string sql = "select * from SHYGdata where 日期='" + date + "'";
