<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index-tb.aspx.cs" Inherits="渠道客服系统.Nhome.index_tb" %>
        ...
        <section class="col-lg-12 connectedSortable ui-sortable" >
          ...
          <div class="nav-tabs-custom" >
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i>淘宝人员数据对比</li>
            </ul>
...
<!-- ./wrapper -->
 ...
 <script type="text/javascript" src="plugins/jQuery/TBchartjs.js"></script>
 <!--jQuery 2.2.0 -->
