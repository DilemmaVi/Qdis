<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="渠道客服系统.Home" %>
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
          <img class="milogo" src="Images/mi_logo.jpg"/>
          <h1>渠道客服信息系统</h1>
        </header>
        <div class="profile-photo-container">
          <img src="Images/mitu1.jpg" alt="Profile Photo" class="img-responsive"/>  
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="#" class="active"><i class="fa fa-home fa-fw"></i>我的首页</a></li>
            <li><a href="data-visualization.html"><i class="fa fa-users fa-fw"></i>业务架构</a></li>
            <li><a href="data-visualization.html"><i class="fa fa-map-marker fa-fw"></i>培训相关</a></li>
            <li><a href="maps.html"><i class="fa fa-bar-chart fa-fw"></i>数据报表</a></li>
            <li><a href="manage-users.html"><i class="fa fa-database fa-fw"></i>自助取数</a></li>
            <li><a href="preferences.html"><i class="fa fa-sliders fa-fw"></i>意见反馈</a></li>
            <li><a href="login.aspx"><i class="fa fa-eject fa-fw"></i>退出登录</a></li>
          </ul>  
        </nav>
      </div>
      <!-- Main content --> 
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="login.aspx" class="active">Admin panel</a></li>
                <li><a href="login.aspx">Dashboard</a></li>
                <li><a href="login.aspx">Overview</a></li>
                <li><a href="login.aspx">Sign in form</a></li>
              </ul>  
            </nav> 
          </div>
        </div>
        <div class="templatemo-content-container">
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2016 小米渠道客服部 
            | Designed by <a href="http://weibo.com/1728947492/profile?topnav=1&wvr=6&is_all=1" target="_blank">小米_威少</a></p>
          </footer>         
        </div>
      </div>
    </div>
